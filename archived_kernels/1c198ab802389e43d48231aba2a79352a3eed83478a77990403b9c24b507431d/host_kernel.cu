...
static void* block_compress_dense_kernel_kernel_packed = NULL;
#ifdef __cplusplus
extern "C"
#endif
int32_t block_compress_dense_kernel(void* self_handle, void* args, int32_t num_args, void* result);
#ifdef __cplusplus
extern "C"
#endif
int32_t block_compress_dense_kernel(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((num_args == 4))) {
    ...
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "block_compress_dense_kernel: num_args should be 4", (long long)(num_args), (long long)(4));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!(!(args == NULL))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "block_compress_dense_kernel: args pointer is NULL");
    return -1;
  }
  ...
  if (!(((((K_handle_type_index == 0) || (K_handle_type_index == 4)) || (K_handle_type_index == 7)) || (64 <= K_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel block_compress_dense_kernel input K expected pointer or tensor handle");
    return -1;
  }
  ...
  if (!(((((block_mask_handle_type_index == 0) || (block_mask_handle_type_index == 4)) || (block_mask_handle_type_index == 7)) || (64 <= block_mask_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel block_compress_dense_kernel input block_mask expected pointer or tensor handle");
    return -1;
  }
  ...
  if (!(((((idx_map_handle_type_index == 0) || (idx_map_handle_type_index == 4)) || (idx_map_handle_type_index == 7)) || (64 <= idx_map_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel block_compress_dense_kernel input idx_map expected pointer or tensor handle");
    return -1;
  }
  int32_t dense_handle_type_index = (((TVMFFIAny*)args)[3].type_index);
  if (!(((((dense_handle_type_index == 0) || (dense_handle_type_index == 4)) || (dense_handle_type_index == 7)) || (64 <= dense_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel block_compress_dense_kernel input dense expected pointer or tensor handle");
    return -1;
  }
  ...
  void* dense_handle = ((dense_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[3].v_ptr) + 24)) : (((TVMFFIAny*)args)[3].v_ptr));
  bool block_compress_dense_kernel_K_is_null = (K_handle == NULL);
  if (!(!block_compress_dense_kernel_K_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "block_compress_dense_kernel.K is expected to have non-NULL pointer");
    return -1;
  }
  bool block_compress_dense_kernel_block_mask_is_null = (block_mask_handle == NULL);
  if (!(!block_compress_dense_kernel_block_mask_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "block_compress_dense_kernel.block_mask is expected to have non-NULL pointer");
    return -1;
  }
  bool block_compress_dense_kernel_idx_map_is_null = (idx_map_handle == NULL);
  if (!(!block_compress_dense_kernel_idx_map_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "block_compress_dense_kernel.idx_map is expected to have non-NULL pointer");
    return -1;
  }
  bool block_compress_dense_kernel_dense_is_null = (dense_handle == NULL);
  if (!(!block_compress_dense_kernel_dense_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "block_compress_dense_kernel.dense is expected to have non-NULL pointer");
    return -1;
  }
  void* block_compress_dense_kernel_K_shape = (((DLTensor*)K_handle)[0].shape);
  void* block_compress_dense_kernel_block_mask_shape = (((DLTensor*)block_mask_handle)[0].shape);
  void* block_compress_dense_kernel_idx_map_shape = (((DLTensor*)idx_map_handle)[0].shape);
  void* block_compress_dense_kernel_dense_shape = (((DLTensor*)dense_handle)[0].shape);
  if ((((DLTensor*)K_handle)[0].ndim) != 4) {
    ...
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
  ...
  int32_t s = ((int32_t)((int64_t*)block_compress_dense_kernel_K_shape)[2]);
  void* block_compress_dense_kernel_K_strides = (((DLTensor*)K_handle)[0].strides);
  ...
  if (!((bool)1)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "Symbolic shape variable blocks_per_head requires at least one non-null buffer among: block_compress_dense_kernel.block_mask, block_compress_dense_kernel.idx_map");
    return -1;
  }
  int32_t blocks_per_head = ((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_shape)[2]);
  void* block_compress_dense_kernel_block_mask_strides = (((DLTensor*)block_mask_handle)[0].strides);
  ...
  void* block_compress_dense_kernel_idx_map_strides = (((DLTensor*)idx_map_handle)[0].strides);
  void* idx_map = (((DLTensor*)idx_map_handle)[0].data);
  if ((((DLTensor*)dense_handle)[0].ndim) != 5) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
  ...
  int32_t dense_blocks_per_head = ((int32_t)((int64_t*)block_compress_dense_kernel_dense_shape)[2]);
  void* block_compress_dense_kernel_dense_strides = (((DLTensor*)dense_handle)[0].strides);
  ...
  if ((((((DLTensor*)K_handle)[0].dtype.code) != (uint8_t)2) || ((((DLTensor*)K_handle)[0].dtype.bits) != (uint8_t)16)) || ((((DLTensor*)K_handle)[0].dtype.lanes) != (uint16_t)1)) {
    ...
    result_5.v_int64 = 0;
    if (TVMFFIFunctionCall(__tvm_error_dtype_mismatch_packed, (TVMFFIAny*) stack_ffi_any, 8, &result_5) != 0) {
      return -1;
    }
  }
  if (((int32_t)((int64_t*)block_compress_dense_kernel_K_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_K_shape)[0]));
  ...
  if (((int32_t)((int64_t*)block_compress_dense_kernel_K_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_K_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)block_compress_dense_kernel_K_shape)[3]) != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_K_shape)[3]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval;
  if ((block_compress_dense_kernel_K_strides == NULL)) {
    condval = 1;
  } else {
    condval = ((int32_t)((int64_t*)block_compress_dense_kernel_K_strides)[3]);
  }
  if (condval != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((block_compress_dense_kernel_K_strides == NULL)) {
      ...
      condval_1 = ((int32_t)((int64_t*)block_compress_dense_kernel_K_strides)[3]);
    }
  ...
  if ((block_compress_dense_kernel_K_strides == NULL)) {
    ...
    condval_2 = ((int32_t)((int64_t*)block_compress_dense_kernel_K_strides)[2]);
  }
  if (condval_2 != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((block_compress_dense_kernel_K_strides == NULL)) {
      ...
      condval_3 = ((int32_t)((int64_t*)block_compress_dense_kernel_K_strides)[2]);
    }
  ...
  if ((block_compress_dense_kernel_K_strides == NULL)) {
    ...
    condval_4 = ((int32_t)((int64_t*)block_compress_dense_kernel_K_strides)[1]);
  }
  if (condval_4 != (s * 128)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((block_compress_dense_kernel_K_strides == NULL)) {
      ...
      condval_5 = ((int32_t)((int64_t*)block_compress_dense_kernel_K_strides)[1]);
    }
  ...
  if ((block_compress_dense_kernel_K_strides == NULL)) {
    ...
    condval_6 = ((int32_t)((int64_t*)block_compress_dense_kernel_K_strides)[0]);
  }
  if (condval_6 != (s * 1024)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((block_compress_dense_kernel_K_strides == NULL)) {
      ...
      condval_7 = ((int32_t)((int64_t*)block_compress_dense_kernel_K_strides)[0]);
    }
  ...
  if (((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_shape)[0]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval_8;
  if ((block_compress_dense_kernel_block_mask_strides == NULL)) {
    condval_8 = 1;
  } else {
    condval_8 = ((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_strides)[2]);
  }
  if (condval_8 != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((block_compress_dense_kernel_block_mask_strides == NULL)) {
      ...
      condval_9 = ((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_strides)[2]);
    }
  ...
  if ((block_compress_dense_kernel_block_mask_strides == NULL)) {
    ...
    condval_10 = ((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_strides)[1]);
  }
  if (condval_10 != ((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    int32_t condval_11;
    if ((block_compress_dense_kernel_block_mask_strides == NULL)) {
      ...
      condval_11 = ((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_strides)[1]);
    }
  ...
  if ((block_compress_dense_kernel_block_mask_strides == NULL)) {
    ...
    condval_12 = ((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_strides)[0]);
  }
  if (condval_12 != (blocks_per_head * 8)) {
    ...
    if ((block_compress_dense_kernel_block_mask_strides == NULL)) {
      ...
      condval_13 = ((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_strides)[0]);
    }
  ...
  if ((uint64_t)0 != (((DLTensor*)block_mask_handle)[0].byte_offset)) {
    ...
    result_22.v_int64 = 0;
    if (TVMFFIFunctionCall(__tvm_error_byte_offset_mismatch_packed, (TVMFFIAny*) stack_ffi_any, 4, &result_22) != 0) {
      return -1;
    }
  }
  ...
  if ((((DLTensor*)block_mask_handle)[0].device.device_type) != 2) {
    ...
    result_24.v_int64 = 0;
    if (TVMFFIFunctionCall(__tvm_error_device_type_mismatch_packed, (TVMFFIAny*) stack_ffi_any, 4, &result_24) != 0) {
      return -1;
    }
  }
  if (blocks_per_head != 0) {
    if (block_mask == NULL) {
      ...
      result_25.v_int64 = 0;
      if (TVMFFIFunctionCall(__tvm_error_null_ptr_packed, (TVMFFIAny*) stack_ffi_any, 3, &result_25) != 0) {
        return -1;
      }
    }
  } else {
  ...
  if ((((((DLTensor*)idx_map_handle)[0].dtype.code) != (uint8_t)0) || ((((DLTensor*)idx_map_handle)[0].dtype.bits) != (uint8_t)16)) || ((((DLTensor*)idx_map_handle)[0].dtype.lanes) != (uint16_t)1)) {
    ...
    result_26.v_int64 = 0;
    if (TVMFFIFunctionCall(__tvm_error_dtype_mismatch_packed, (TVMFFIAny*) stack_ffi_any, 8, &result_26) != 0) {
      return -1;
    }
  }
  if (((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_shape)[0]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_shape)[2]) != ((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval_14;
  if ((block_compress_dense_kernel_idx_map_strides == NULL)) {
    condval_14 = 1;
  } else {
    condval_14 = ((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_strides)[2]);
  }
  if (condval_14 != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((block_compress_dense_kernel_idx_map_strides == NULL)) {
      ...
      condval_15 = ((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_strides)[2]);
    }
  ...
  if ((block_compress_dense_kernel_idx_map_strides == NULL)) {
    ...
    condval_16 = ((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_strides)[1]);
  }
  if (condval_16 != ((int32_t)((int64_t*)block_compress_dense_kernel_block_mask_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    if ((block_compress_dense_kernel_idx_map_strides == NULL)) {
      ...
      condval_17 = ((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_strides)[1]);
    }
  ...
  if ((block_compress_dense_kernel_idx_map_strides == NULL)) {
    ...
    condval_18 = ((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_strides)[0]);
  }
  if (condval_18 != (blocks_per_head * 8)) {
    ...
    if ((block_compress_dense_kernel_idx_map_strides == NULL)) {
      ...
      condval_19 = ((int32_t)((int64_t*)block_compress_dense_kernel_idx_map_strides)[0]);
    }
  ...
  if (((int32_t)((int64_t*)block_compress_dense_kernel_dense_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_dense_shape)[0]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)block_compress_dense_kernel_dense_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_dense_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)block_compress_dense_kernel_dense_shape)[3]) != 64) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_dense_shape)[3]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)block_compress_dense_kernel_dense_shape)[4]) != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)block_compress_dense_kernel_dense_shape)[4]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval_20;
  if ((block_compress_dense_kernel_dense_strides == NULL)) {
    condval_20 = 1;
  } else {
    condval_20 = ((int32_t)((int64_t*)block_compress_dense_kernel_dense_strides)[4]);
  }
  if (condval_20 != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((block_compress_dense_kernel_dense_strides == NULL)) {
      ...
      condval_21 = ((int32_t)((int64_t*)block_compress_dense_kernel_dense_strides)[4]);
    }
  ...
  if ((block_compress_dense_kernel_dense_strides == NULL)) {
    ...
    condval_22 = ((int32_t)((int64_t*)block_compress_dense_kernel_dense_strides)[3]);
  }
  if (condval_22 != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((block_compress_dense_kernel_dense_strides == NULL)) {
      ...
      condval_23 = ((int32_t)((int64_t*)block_compress_dense_kernel_dense_strides)[3]);
    }
  ...
  if ((block_compress_dense_kernel_dense_strides == NULL)) {
    ...
    condval_24 = ((int32_t)((int64_t*)block_compress_dense_kernel_dense_strides)[2]);
  }
  if (condval_24 != 8192) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((block_compress_dense_kernel_dense_strides == NULL)) {
      ...
      condval_25 = ((int32_t)((int64_t*)block_compress_dense_kernel_dense_strides)[2]);
    }
  ...
  if ((block_compress_dense_kernel_dense_strides == NULL)) {
    ...
    condval_26 = ((int32_t)((int64_t*)block_compress_dense_kernel_dense_strides)[1]);
  }
  if (condval_26 != (dense_blocks_per_head * 8192)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = (((int64_t)dense_blocks_per_head) * (int64_t)8192);
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    int32_t condval_27;
    if ((block_compress_dense_kernel_dense_strides == NULL)) {
      ...
      condval_27 = ((int32_t)((int64_t*)block_compress_dense_kernel_dense_strides)[1]);
    }
  ...
  if ((block_compress_dense_kernel_dense_strides == NULL)) {
    ...
    condval_28 = ((int32_t)((int64_t*)block_compress_dense_kernel_dense_strides)[0]);
  }
  if (condval_28 != (dense_blocks_per_head * 65536)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = (((int64_t)dense_blocks_per_head) * (int64_t)65536);
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    int32_t condval_29;
    if ((block_compress_dense_kernel_dense_strides == NULL)) {
      ...
      condval_29 = ((int32_t)((int64_t*)block_compress_dense_kernel_dense_strides)[0]);
    }
  ...
  if ((uint64_t)0 != (((DLTensor*)dense_handle)[0].byte_offset)) {
    ...
    result_47.v_int64 = 0;
    if (TVMFFIFunctionCall(__tvm_error_byte_offset_mismatch_packed, (TVMFFIAny*) stack_ffi_any, 4, &result_47) != 0) {
      return -1;
    }
  }
  if ((((DLTensor*)dense_handle)[0].device.device_id) != (((DLTensor*)K_handle)[0].device.device_id)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"block_compress_dense_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)(((DLTensor*)dense_handle)[0].device.device_id));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if ((((DLTensor*)dense_handle)[0].device.device_type) != 2) {
    ...
    result_49.v_int64 = 0;
    if (TVMFFIFunctionCall(__tvm_error_device_type_mismatch_packed, (TVMFFIAny*) stack_ffi_any, 4, &result_49) != 0) {
      return -1;
    }
  }
  if (dense_blocks_per_head != 0) {
    if (dense == NULL) {
      ...
      result_50.v_int64 = 0;
      if (TVMFFIFunctionCall(__tvm_error_null_ptr_packed, (TVMFFIAny*) stack_ffi_any, 3, &result_50) != 0) {
        return -1;
      }
    }
  } else {
  ...
  result_51.v_int64 = 0;
  if (TVMFFIFunctionCall(__tvm_set_device_packed, (TVMFFIAny*) stack_ffi_any, 2, &result_51) != 0) {
    return -1;
  }
  if (K == NULL) {
  ...
  (((TVMFFIAny*)stack_ffi_any)[2].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[2].v_int64) = 0;
  (((TVMFFIAny*)stack_ffi_any)[2].v_ptr) = dense;
  if (idx_map == NULL) {
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 0;
  } else {
  ...
  (((TVMFFIAny*)stack_ffi_any)[3].v_ptr) = idx_map;
  (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
  (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)blocks_per_head);
  (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 1;
  (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = ((int64_t)dense_blocks_per_head);
  (((TVMFFIAny*)stack_ffi_any)[6].type_index) = 1;
  (((TVMFFIAny*)stack_ffi_any)[6].zero_padding) = 0;
  ...
  (((TVMFFIAny*)stack_ffi_any)[12].v_int64) = ((int64_t)16384);
  ...
  if (block_compress_dense_kernel_kernel_packed == NULL) {
    if (TVMBackendGetFuncFromEnv(__tvm_ffi__library_ctx, "block_compress_dense_kernel_kernel", &block_compress_dense_kernel_kernel_packed) != 0) {
      return -1;
    }
  }
  TVMFFIAny result_52;
  ...
  result_52.v_int64 = 0;
  if (TVMFFIFunctionCall(block_compress_dense_kernel_kernel_packed, (TVMFFIAny*) stack_ffi_any, 13, &result_52) != 0) {
    return -1;
  }
  return 0;
}
...
int32_t __tvm_ffi_main(void* self, void* args,int num_args, void* result) {
  return block_compress_dense_kernel(self, args, num_args, result);
}

...
static void* prune_and_compress_value_kernel_kernel_packed = NULL;
#ifdef __cplusplus
extern "C"
#endif
int32_t prune_and_compress_value_kernel(void* self_handle, void* args, int32_t num_args, void* result);
#ifdef __cplusplus
extern "C"
#endif
int32_t prune_and_compress_value_kernel(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((num_args == 3))) {
    ...
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "prune_and_compress_value_kernel: num_args should be 3", (long long)(num_args), (long long)(3));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!(!(args == NULL))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "prune_and_compress_value_kernel: args pointer is NULL");
    return -1;
  }
  ...
  if (!(((((Dense_handle_type_index == 0) || (Dense_handle_type_index == 4)) || (Dense_handle_type_index == 7)) || (64 <= Dense_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel prune_and_compress_value_kernel input Dense expected pointer or tensor handle");
    return -1;
  }
  ...
  if (!(((((Sparse_handle_type_index == 0) || (Sparse_handle_type_index == 4)) || (Sparse_handle_type_index == 7)) || (64 <= Sparse_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel prune_and_compress_value_kernel input Sparse expected pointer or tensor handle");
    return -1;
  }
  ...
  if (!(((((Meta_handle_type_index == 0) || (Meta_handle_type_index == 4)) || (Meta_handle_type_index == 7)) || (64 <= Meta_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel prune_and_compress_value_kernel input Meta expected pointer or tensor handle");
    return -1;
  }
  ...
  bool prune_and_compress_value_kernel_Dense_is_null = (Dense_handle == NULL);
  if (!(!prune_and_compress_value_kernel_Dense_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "prune_and_compress_value_kernel.Dense is expected to have non-NULL pointer");
    return -1;
  }
  bool prune_and_compress_value_kernel_Sparse_is_null = (Sparse_handle == NULL);
  if (!(!prune_and_compress_value_kernel_Sparse_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "prune_and_compress_value_kernel.Sparse is expected to have non-NULL pointer");
    return -1;
  }
  bool prune_and_compress_value_kernel_Meta_is_null = (Meta_handle == NULL);
  if (!(!prune_and_compress_value_kernel_Meta_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "prune_and_compress_value_kernel.Meta is expected to have non-NULL pointer");
    return -1;
  }
  void* prune_and_compress_value_kernel_Dense_shape = (((DLTensor*)Dense_handle)[0].shape);
  void* prune_and_compress_value_kernel_Sparse_shape = (((DLTensor*)Sparse_handle)[0].shape);
  void* prune_and_compress_value_kernel_Meta_shape = (((DLTensor*)Meta_handle)[0].shape);
  if ((((DLTensor*)Dense_handle)[0].ndim) != 4) {
    ...
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
  ...
  int32_t S = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_shape)[2]);
  void* prune_and_compress_value_kernel_Dense_strides = (((DLTensor*)Dense_handle)[0].strides);
  ...
  void* prune_and_compress_value_kernel_Sparse_strides = (((DLTensor*)Sparse_handle)[0].strides);
  ...
  void* prune_and_compress_value_kernel_Meta_strides = (((DLTensor*)Meta_handle)[0].strides);
  ...
  if (((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_shape)[0]));
  ...
  if (((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_shape)[3]) != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_shape)[3]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval;
  if ((prune_and_compress_value_kernel_Dense_strides == NULL)) {
    condval = 1;
  } else {
    condval = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_strides)[3]);
  }
  if (condval != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_and_compress_value_kernel_Dense_strides == NULL)) {
      ...
      condval_1 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_strides)[3]);
    }
  ...
  if ((prune_and_compress_value_kernel_Dense_strides == NULL)) {
    ...
    condval_2 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_strides)[2]);
  }
  if (condval_2 != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_and_compress_value_kernel_Dense_strides == NULL)) {
      ...
      condval_3 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_strides)[2]);
    }
  ...
  if ((prune_and_compress_value_kernel_Dense_strides == NULL)) {
    ...
    condval_4 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_strides)[1]);
  }
  if (condval_4 != (S * 128)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_and_compress_value_kernel_Dense_strides == NULL)) {
      ...
      condval_5 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_strides)[1]);
    }
  ...
  if ((prune_and_compress_value_kernel_Dense_strides == NULL)) {
    ...
    condval_6 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_strides)[0]);
  }
  if (condval_6 != (S * 1024)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_and_compress_value_kernel_Dense_strides == NULL)) {
      ...
      condval_7 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Dense_strides)[0]);
    }
  ...
  if (((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_shape)[0]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_shape)[2]) != (S >> 1)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = (((int64_t)S) >> (int64_t)1);
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_shape)[3]) != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_shape)[3]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval_8;
  if ((prune_and_compress_value_kernel_Sparse_strides == NULL)) {
    condval_8 = 1;
  } else {
    condval_8 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_strides)[3]);
  }
  if (condval_8 != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_and_compress_value_kernel_Sparse_strides == NULL)) {
      ...
      condval_9 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_strides)[3]);
    }
  ...
  if ((prune_and_compress_value_kernel_Sparse_strides == NULL)) {
    ...
    condval_10 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_strides)[2]);
  }
  if (condval_10 != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_and_compress_value_kernel_Sparse_strides == NULL)) {
      ...
      condval_11 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_strides)[2]);
    }
  ...
  if ((prune_and_compress_value_kernel_Sparse_strides == NULL)) {
    ...
    condval_12 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_strides)[1]);
  }
  if (condval_12 != ((S >> 1) * 128)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((((int64_t)S) >> (int64_t)1) * (int64_t)128);
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    int32_t condval_13;
    if ((prune_and_compress_value_kernel_Sparse_strides == NULL)) {
      ...
      condval_13 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_strides)[1]);
    }
  ...
  if ((prune_and_compress_value_kernel_Sparse_strides == NULL)) {
    ...
    condval_14 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_strides)[0]);
  }
  if (condval_14 != ((S >> 1) * 1024)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((((int64_t)S) >> (int64_t)1) * (int64_t)1024);
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    int32_t condval_15;
    if ((prune_and_compress_value_kernel_Sparse_strides == NULL)) {
      ...
      condval_15 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Sparse_strides)[0]);
    }
  ...
  if (((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_shape)[0]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_shape)[2]) != (S >> 4)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = (((int64_t)S) >> (int64_t)4);
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_shape)[3]) != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_shape)[3]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval_16;
  if ((prune_and_compress_value_kernel_Meta_strides == NULL)) {
    condval_16 = 1;
  } else {
    condval_16 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_strides)[3]);
  }
  if (condval_16 != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_and_compress_value_kernel_Meta_strides == NULL)) {
      ...
      condval_17 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_strides)[3]);
    }
  ...
  if ((prune_and_compress_value_kernel_Meta_strides == NULL)) {
    ...
    condval_18 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_strides)[2]);
  }
  if (condval_18 != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_and_compress_value_kernel_Meta_strides == NULL)) {
      ...
      condval_19 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_strides)[2]);
    }
  ...
  if ((prune_and_compress_value_kernel_Meta_strides == NULL)) {
    ...
    condval_20 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_strides)[1]);
  }
  if (condval_20 != ((S >> 4) * 128)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((((int64_t)S) >> (int64_t)4) * (int64_t)128);
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    int32_t condval_21;
    if ((prune_and_compress_value_kernel_Meta_strides == NULL)) {
      ...
      condval_21 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_strides)[1]);
    }
  ...
  if ((prune_and_compress_value_kernel_Meta_strides == NULL)) {
    ...
    condval_22 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_strides)[0]);
  }
  if (condval_22 != ((S >> 4) * 1024)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_and_compress_value_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((((int64_t)S) >> (int64_t)4) * (int64_t)1024);
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    int32_t condval_23;
    if ((prune_and_compress_value_kernel_Meta_strides == NULL)) {
      ...
      condval_23 = ((int32_t)((int64_t*)prune_and_compress_value_kernel_Meta_strides)[0]);
    }
  ...
  (((TVMFFIAny*)stack_ffi_any)[6].type_index) = 1;
  (((TVMFFIAny*)stack_ffi_any)[6].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[6].v_int64) = ((int64_t)(S >> 4));
  (((TVMFFIAny*)stack_ffi_any)[7].type_index) = 1;
  (((TVMFFIAny*)stack_ffi_any)[7].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[7].v_int64) = ((int64_t)1);
  ...
  if (prune_and_compress_value_kernel_kernel_packed == NULL) {
    if (TVMBackendGetFuncFromEnv(__tvm_ffi__library_ctx, "prune_and_compress_value_kernel_kernel", &prune_and_compress_value_kernel_kernel_packed) != 0) {
      return -1;
    }
  }
  TVMFFIAny result_42;
  ...
  result_42.v_int64 = 0;
  if (TVMFFIFunctionCall(prune_and_compress_value_kernel_kernel_packed, (TVMFFIAny*) stack_ffi_any, 10, &result_42) != 0) {
    return -1;
  }
  return 0;
}
...
int32_t __tvm_ffi_main(void* self, void* args,int num_args, void* result) {
  return prune_and_compress_value_kernel(self, args, num_args, result);
}

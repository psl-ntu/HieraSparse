...
static void* prune_block_key_mask_kernel_kernel_packed = NULL;
#ifdef __cplusplus
extern "C"
#endif
int32_t prune_block_key_mask_kernel(void* self_handle, void* args, int32_t num_args, void* result);
#ifdef __cplusplus
extern "C"
#endif
int32_t prune_block_key_mask_kernel(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((num_args == 2))) {
    ...
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "prune_block_key_mask_kernel: num_args should be 2", (long long)(num_args), (long long)(2));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!(!(args == NULL))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "prune_block_key_mask_kernel: args pointer is NULL");
    return -1;
  }
  ...
  if (!(((((K_handle_type_index == 0) || (K_handle_type_index == 4)) || (K_handle_type_index == 7)) || (64 <= K_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel prune_block_key_mask_kernel input K expected pointer or tensor handle");
    return -1;
  }
  ...
  if (!(((((prune_loss_handle_type_index == 0) || (prune_loss_handle_type_index == 4)) || (prune_loss_handle_type_index == 7)) || (64 <= prune_loss_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel prune_block_key_mask_kernel input prune_loss expected pointer or tensor handle");
    return -1;
  }
  ...
  bool prune_block_key_mask_kernel_K_is_null = (K_handle == NULL);
  if (!(!prune_block_key_mask_kernel_K_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "prune_block_key_mask_kernel.K is expected to have non-NULL pointer");
    return -1;
  }
  bool prune_block_key_mask_kernel_prune_loss_is_null = (prune_loss_handle == NULL);
  if (!(!prune_block_key_mask_kernel_prune_loss_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "prune_block_key_mask_kernel.prune_loss is expected to have non-NULL pointer");
    return -1;
  }
  void* prune_block_key_mask_kernel_K_shape = (((DLTensor*)K_handle)[0].shape);
  void* prune_block_key_mask_kernel_prune_loss_shape = (((DLTensor*)prune_loss_handle)[0].shape);
  if ((((DLTensor*)K_handle)[0].ndim) != 5) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_block_key_mask_kernel";
  ...
  if (!((bool)1)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "Symbolic shape variable num_blocks requires at least one non-null buffer among: prune_block_key_mask_kernel.K, prune_block_key_mask_kernel.prune_loss");
    return -1;
  }
  int32_t num_blocks = ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[2]);
  void* prune_block_key_mask_kernel_K_strides = (((DLTensor*)K_handle)[0].strides);
  ...
  void* prune_block_key_mask_kernel_prune_loss_strides = (((DLTensor*)prune_loss_handle)[0].strides);
  ...
  if (((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_block_key_mask_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[0]));
  ...
  if (((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_block_key_mask_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[3]) != 64) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_block_key_mask_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[3]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[4]) != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_block_key_mask_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[4]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval;
  if ((prune_block_key_mask_kernel_K_strides == NULL)) {
    condval = 1;
  } else {
    condval = ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_strides)[4]);
  }
  if (condval != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_block_key_mask_kernel_K_strides == NULL)) {
      ...
      condval_1 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_strides)[4]);
    }
  ...
  if ((prune_block_key_mask_kernel_K_strides == NULL)) {
    ...
    condval_2 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_strides)[3]);
  }
  if (condval_2 != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_block_key_mask_kernel_K_strides == NULL)) {
      ...
      condval_3 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_strides)[3]);
    }
  ...
  if ((prune_block_key_mask_kernel_K_strides == NULL)) {
    ...
    condval_4 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_strides)[2]);
  }
  if (condval_4 != 8192) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_block_key_mask_kernel_K_strides == NULL)) {
      ...
      condval_5 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_strides)[2]);
    }
  ...
  if ((prune_block_key_mask_kernel_K_strides == NULL)) {
    ...
    condval_6 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_strides)[1]);
  }
  if (condval_6 != (num_blocks * 8192)) {
    ...
    if ((prune_block_key_mask_kernel_K_strides == NULL)) {
      ...
      condval_7 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_strides)[1]);
    }
  ...
  if ((prune_block_key_mask_kernel_K_strides == NULL)) {
    ...
    condval_8 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_strides)[0]);
  }
  if (condval_8 != (num_blocks * 65536)) {
    ...
    if ((prune_block_key_mask_kernel_K_strides == NULL)) {
      ...
      condval_9 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_strides)[0]);
    }
  ...
  if (((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_block_key_mask_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_shape)[0]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_block_key_mask_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[2]) != ((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_block_key_mask_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval_10;
  if ((prune_block_key_mask_kernel_prune_loss_strides == NULL)) {
    condval_10 = 1;
  } else {
    condval_10 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_strides)[2]);
  }
  if (condval_10 != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((prune_block_key_mask_kernel_prune_loss_strides == NULL)) {
      ...
      condval_11 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_strides)[2]);
    }
  ...
  if ((prune_block_key_mask_kernel_prune_loss_strides == NULL)) {
    ...
    condval_12 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_strides)[1]);
  }
  if (condval_12 != ((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_block_key_mask_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)((int32_t)((int64_t*)prune_block_key_mask_kernel_K_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    int32_t condval_13;
    if ((prune_block_key_mask_kernel_prune_loss_strides == NULL)) {
      ...
      condval_13 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_strides)[1]);
    }
  ...
  if ((prune_block_key_mask_kernel_prune_loss_strides == NULL)) {
    ...
    condval_14 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_strides)[0]);
  }
  if (condval_14 != (num_blocks * 8)) {
    ...
    if ((prune_block_key_mask_kernel_prune_loss_strides == NULL)) {
      ...
      condval_15 = ((int32_t)((int64_t*)prune_block_key_mask_kernel_prune_loss_strides)[0]);
    }
  ...
  if ((((DLTensor*)prune_loss_handle)[0].device.device_id) != (((DLTensor*)K_handle)[0].device.device_id)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"prune_block_key_mask_kernel";
  ...
  (((TVMFFIAny*)stack_ffi_any)[7].type_index) = 1;
  (((TVMFFIAny*)stack_ffi_any)[7].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[7].v_int64) = ((int64_t)4);
  ...
  if (prune_block_key_mask_kernel_kernel_packed == NULL) {
    if (TVMBackendGetFuncFromEnv(__tvm_ffi__library_ctx, "prune_block_key_mask_kernel_kernel", &prune_block_key_mask_kernel_kernel_packed) != 0) {
      return -1;
    }
  }
  TVMFFIAny result_28;
  ...
  result_28.v_int64 = 0;
  if (TVMFFIFunctionCall(prune_block_key_mask_kernel_kernel_packed, (TVMFFIAny*) stack_ffi_any, 10, &result_28) != 0) {
    return -1;
  }
  return 0;
}
...
int32_t __tvm_ffi_main(void* self, void* args,int num_args, void* result) {
  return prune_block_key_mask_kernel(self, args, num_args, result);
}

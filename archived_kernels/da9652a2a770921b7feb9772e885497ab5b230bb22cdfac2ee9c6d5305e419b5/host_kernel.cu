...
static void* flashattn_kernel_kernel_packed = NULL;
#ifdef __cplusplus
extern "C"
#endif
int32_t flashattn_kernel(void* self_handle, void* args, int32_t num_args, void* result);
#ifdef __cplusplus
extern "C"
#endif
int32_t flashattn_kernel(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((num_args == 5))) {
    ...
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "flashattn_kernel: num_args should be 5", (long long)(num_args), (long long)(5));
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", __tvm_assert_msg_buf);
    return -1;
  }
  if (!(!(args == NULL))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "flashattn_kernel: args pointer is NULL");
    return -1;
  }
  ...
  if (!(((((Q_handle_type_index == 0) || (Q_handle_type_index == 4)) || (Q_handle_type_index == 7)) || (64 <= Q_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel flashattn_kernel input Q expected pointer or tensor handle");
    return -1;
  }
  ...
  if (!(((((K_handle_type_index == 0) || (K_handle_type_index == 4)) || (K_handle_type_index == 7)) || (64 <= K_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel flashattn_kernel input K expected pointer or tensor handle");
    return -1;
  }
  ...
  if (!(((((V_handle_type_index == 0) || (V_handle_type_index == 4)) || (V_handle_type_index == 7)) || (64 <= V_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel flashattn_kernel input V expected pointer or tensor handle");
    return -1;
  }
  int32_t Output_handle_type_index = (((TVMFFIAny*)args)[3].type_index);
  if (!(((((Output_handle_type_index == 0) || (Output_handle_type_index == 4)) || (Output_handle_type_index == 7)) || (64 <= Output_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel flashattn_kernel input Output expected pointer or tensor handle");
    return -1;
  }
  int32_t lse_handle_type_index = (((TVMFFIAny*)args)[4].type_index);
  if (!(((((lse_handle_type_index == 0) || (lse_handle_type_index == 4)) || (lse_handle_type_index == 7)) || (64 <= lse_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel flashattn_kernel input lse expected pointer or tensor handle");
    return -1;
  }
  ...
  void* Output_handle = ((Output_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[3].v_ptr) + 24)) : (((TVMFFIAny*)args)[3].v_ptr));
  void* lse_handle = ((lse_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[4].v_ptr) + 24)) : (((TVMFFIAny*)args)[4].v_ptr));
  bool flashattn_kernel_Q_is_null = (Q_handle == NULL);
  if (!(!flashattn_kernel_Q_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "flashattn_kernel.Q is expected to have non-NULL pointer");
    return -1;
  }
  bool flashattn_kernel_K_is_null = (K_handle == NULL);
  if (!(!flashattn_kernel_K_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "flashattn_kernel.K is expected to have non-NULL pointer");
    return -1;
  }
  bool flashattn_kernel_V_is_null = (V_handle == NULL);
  if (!(!flashattn_kernel_V_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "flashattn_kernel.V is expected to have non-NULL pointer");
    return -1;
  }
  bool flashattn_kernel_Output_is_null = (Output_handle == NULL);
  if (!(!flashattn_kernel_Output_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "flashattn_kernel.Output is expected to have non-NULL pointer");
    return -1;
  }
  bool flashattn_kernel_lse_is_null = (lse_handle == NULL);
  if (!(!flashattn_kernel_lse_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "flashattn_kernel.lse is expected to have non-NULL pointer");
    return -1;
  }
  void* flashattn_kernel_Q_shape = (((DLTensor*)Q_handle)[0].shape);
  void* flashattn_kernel_K_shape = (((DLTensor*)K_handle)[0].shape);
  void* flashattn_kernel_V_shape = (((DLTensor*)V_handle)[0].shape);
  void* flashattn_kernel_Output_shape = (((DLTensor*)Output_handle)[0].shape);
  void* flashattn_kernel_lse_shape = (((DLTensor*)lse_handle)[0].shape);
  if ((((DLTensor*)Q_handle)[0].ndim) != 4) {
    ...
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
  ...
  if (!((bool)1)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "Symbolic shape variable seq_q requires at least one non-null buffer among: flashattn_kernel.Q, flashattn_kernel.Output, flashattn_kernel.lse");
    return -1;
  }
  int32_t seq_q = ((int32_t)((int64_t*)flashattn_kernel_Q_shape)[2]);
  void* flashattn_kernel_Q_strides = (((DLTensor*)Q_handle)[0].strides);
  ...
  if (!((bool)1)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "Symbolic shape variable seq_kv requires at least one non-null buffer among: flashattn_kernel.K, flashattn_kernel.V");
    return -1;
  }
  int32_t seq_kv = ((int32_t)((int64_t*)flashattn_kernel_K_shape)[2]);
  void* flashattn_kernel_K_strides = (((DLTensor*)K_handle)[0].strides);
  ...
  void* flashattn_kernel_V_strides = (((DLTensor*)V_handle)[0].strides);
  ...
  void* flashattn_kernel_Output_strides = (((DLTensor*)Output_handle)[0].strides);
  ...
  void* flashattn_kernel_lse_strides = (((DLTensor*)lse_handle)[0].strides);
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_Q_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_Q_shape)[0]));
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_Q_shape)[1]) != 32) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_Q_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_Q_shape)[3]) != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_Q_shape)[3]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval;
  if ((flashattn_kernel_Q_strides == NULL)) {
    condval = 1;
  } else {
    condval = ((int32_t)((int64_t*)flashattn_kernel_Q_strides)[3]);
  }
  if (condval != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((flashattn_kernel_Q_strides == NULL)) {
      ...
      condval_1 = ((int32_t)((int64_t*)flashattn_kernel_Q_strides)[3]);
    }
  ...
  if ((flashattn_kernel_Q_strides == NULL)) {
    ...
    condval_2 = ((int32_t)((int64_t*)flashattn_kernel_Q_strides)[2]);
  }
  if (condval_2 != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((flashattn_kernel_Q_strides == NULL)) {
      ...
      condval_3 = ((int32_t)((int64_t*)flashattn_kernel_Q_strides)[2]);
    }
  ...
  if ((flashattn_kernel_Q_strides == NULL)) {
    ...
    condval_4 = ((int32_t)((int64_t*)flashattn_kernel_Q_strides)[1]);
  }
  if (condval_4 != (seq_q * 128)) {
    ...
    if ((flashattn_kernel_Q_strides == NULL)) {
      ...
      condval_5 = ((int32_t)((int64_t*)flashattn_kernel_Q_strides)[1]);
    }
  ...
  if ((flashattn_kernel_Q_strides == NULL)) {
    ...
    condval_6 = ((int32_t)((int64_t*)flashattn_kernel_Q_strides)[0]);
  }
  if (condval_6 != (seq_q * 4096)) {
    ...
    if ((flashattn_kernel_Q_strides == NULL)) {
      ...
      condval_7 = ((int32_t)((int64_t*)flashattn_kernel_Q_strides)[0]);
    }
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_K_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_K_shape)[0]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_K_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_K_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_K_shape)[3]) != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_K_shape)[3]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval_8;
  if ((flashattn_kernel_K_strides == NULL)) {
    condval_8 = 1;
  } else {
    condval_8 = ((int32_t)((int64_t*)flashattn_kernel_K_strides)[3]);
  }
  if (condval_8 != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((flashattn_kernel_K_strides == NULL)) {
      ...
      condval_9 = ((int32_t)((int64_t*)flashattn_kernel_K_strides)[3]);
    }
  ...
  if ((flashattn_kernel_K_strides == NULL)) {
    ...
    condval_10 = ((int32_t)((int64_t*)flashattn_kernel_K_strides)[2]);
  }
  if (condval_10 != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((flashattn_kernel_K_strides == NULL)) {
      ...
      condval_11 = ((int32_t)((int64_t*)flashattn_kernel_K_strides)[2]);
    }
  ...
  if ((flashattn_kernel_K_strides == NULL)) {
    ...
    condval_12 = ((int32_t)((int64_t*)flashattn_kernel_K_strides)[1]);
  }
  if (condval_12 != (seq_kv * 128)) {
    ...
    if ((flashattn_kernel_K_strides == NULL)) {
      ...
      condval_13 = ((int32_t)((int64_t*)flashattn_kernel_K_strides)[1]);
    }
  ...
  if ((flashattn_kernel_K_strides == NULL)) {
    ...
    condval_14 = ((int32_t)((int64_t*)flashattn_kernel_K_strides)[0]);
  }
  if (condval_14 != (seq_kv * 1024)) {
    ...
    if ((flashattn_kernel_K_strides == NULL)) {
      ...
      condval_15 = ((int32_t)((int64_t*)flashattn_kernel_K_strides)[0]);
    }
  ...
  if ((uint64_t)0 != (((DLTensor*)K_handle)[0].byte_offset)) {
    ...
    result_25.v_int64 = 0;
    if (TVMFFIFunctionCall(__tvm_error_byte_offset_mismatch_packed, (TVMFFIAny*) stack_ffi_any, 4, &result_25) != 0) {
      return -1;
    }
  }
  ...
  if ((((DLTensor*)K_handle)[0].device.device_type) != 2) {
    ...
    result_27.v_int64 = 0;
    if (TVMFFIFunctionCall(__tvm_error_device_type_mismatch_packed, (TVMFFIAny*) stack_ffi_any, 4, &result_27) != 0) {
      return -1;
    }
  }
  if (seq_kv != 0) {
    if (K == NULL) {
      ...
      result_28.v_int64 = 0;
      if (TVMFFIFunctionCall(__tvm_error_null_ptr_packed, (TVMFFIAny*) stack_ffi_any, 3, &result_28) != 0) {
        return -1;
      }
    }
  } else {
  ...
  if ((((((DLTensor*)V_handle)[0].dtype.code) != (uint8_t)2) || ((((DLTensor*)V_handle)[0].dtype.bits) != (uint8_t)16)) || ((((DLTensor*)V_handle)[0].dtype.lanes) != (uint16_t)1)) {
    ...
    result_29.v_int64 = 0;
    if (TVMFFIFunctionCall(__tvm_error_dtype_mismatch_packed, (TVMFFIAny*) stack_ffi_any, 8, &result_29) != 0) {
      return -1;
    }
  }
  if (((int32_t)((int64_t*)flashattn_kernel_V_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_V_shape)[0]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_V_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_V_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_K_shape)[2]) != ((int32_t)((int64_t*)flashattn_kernel_V_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_V_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_K_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_V_shape)[3]) != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_V_shape)[3]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval_16;
  if ((flashattn_kernel_V_strides == NULL)) {
    condval_16 = 1;
  } else {
    condval_16 = ((int32_t)((int64_t*)flashattn_kernel_V_strides)[3]);
  }
  if (condval_16 != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((flashattn_kernel_V_strides == NULL)) {
      ...
      condval_17 = ((int32_t)((int64_t*)flashattn_kernel_V_strides)[3]);
    }
  ...
  if ((flashattn_kernel_V_strides == NULL)) {
    ...
    condval_18 = ((int32_t)((int64_t*)flashattn_kernel_V_strides)[2]);
  }
  if (condval_18 != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((flashattn_kernel_V_strides == NULL)) {
      ...
      condval_19 = ((int32_t)((int64_t*)flashattn_kernel_V_strides)[2]);
    }
  ...
  if ((flashattn_kernel_V_strides == NULL)) {
    ...
    condval_20 = ((int32_t)((int64_t*)flashattn_kernel_V_strides)[1]);
  }
  if (condval_20 != (seq_kv * 128)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    if ((flashattn_kernel_V_strides == NULL)) {
      ...
      condval_21 = ((int32_t)((int64_t*)flashattn_kernel_V_strides)[1]);
    }
  ...
  if ((flashattn_kernel_V_strides == NULL)) {
    ...
    condval_22 = ((int32_t)((int64_t*)flashattn_kernel_V_strides)[0]);
  }
  if (condval_22 != (seq_kv * 1024)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    if ((flashattn_kernel_V_strides == NULL)) {
      ...
      condval_23 = ((int32_t)((int64_t*)flashattn_kernel_V_strides)[0]);
    }
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_Output_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_Output_shape)[0]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_Output_shape)[1]) != 32) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_Output_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_Q_shape)[2]) != ((int32_t)((int64_t*)flashattn_kernel_Output_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_Output_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_Q_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_Output_shape)[3]) != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_Output_shape)[3]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval_24;
  if ((flashattn_kernel_Output_strides == NULL)) {
    condval_24 = 1;
  } else {
    condval_24 = ((int32_t)((int64_t*)flashattn_kernel_Output_strides)[3]);
  }
  if (condval_24 != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((flashattn_kernel_Output_strides == NULL)) {
      ...
      condval_25 = ((int32_t)((int64_t*)flashattn_kernel_Output_strides)[3]);
    }
  ...
  if ((flashattn_kernel_Output_strides == NULL)) {
    ...
    condval_26 = ((int32_t)((int64_t*)flashattn_kernel_Output_strides)[2]);
  }
  if (condval_26 != 128) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((flashattn_kernel_Output_strides == NULL)) {
      ...
      condval_27 = ((int32_t)((int64_t*)flashattn_kernel_Output_strides)[2]);
    }
  ...
  if ((flashattn_kernel_Output_strides == NULL)) {
    ...
    condval_28 = ((int32_t)((int64_t*)flashattn_kernel_Output_strides)[1]);
  }
  if (condval_28 != (seq_q * 128)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    if ((flashattn_kernel_Output_strides == NULL)) {
      ...
      condval_29 = ((int32_t)((int64_t*)flashattn_kernel_Output_strides)[1]);
    }
  ...
  if ((flashattn_kernel_Output_strides == NULL)) {
    ...
    condval_30 = ((int32_t)((int64_t*)flashattn_kernel_Output_strides)[0]);
  }
  if (condval_30 != (seq_q * 4096)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    if ((flashattn_kernel_Output_strides == NULL)) {
      ...
      condval_31 = ((int32_t)((int64_t*)flashattn_kernel_Output_strides)[0]);
    }
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_lse_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_lse_shape)[0]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_lse_shape)[1]) != 32) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_lse_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)flashattn_kernel_Q_shape)[2]) != ((int32_t)((int64_t*)flashattn_kernel_lse_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_lse_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_Q_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
  ...
  int32_t condval_32;
  if ((flashattn_kernel_lse_strides == NULL)) {
    condval_32 = 1;
  } else {
    condval_32 = ((int32_t)((int64_t*)flashattn_kernel_lse_strides)[2]);
  }
  if (condval_32 != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((flashattn_kernel_lse_strides == NULL)) {
      ...
      condval_33 = ((int32_t)((int64_t*)flashattn_kernel_lse_strides)[2]);
    }
  ...
  if ((flashattn_kernel_lse_strides == NULL)) {
    ...
    condval_34 = ((int32_t)((int64_t*)flashattn_kernel_lse_strides)[1]);
  }
  if (condval_34 != ((int32_t)((int64_t*)flashattn_kernel_Q_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)((int32_t)((int64_t*)flashattn_kernel_Q_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    int32_t condval_35;
    if ((flashattn_kernel_lse_strides == NULL)) {
      ...
      condval_35 = ((int32_t)((int64_t*)flashattn_kernel_lse_strides)[1]);
    }
  ...
  if ((flashattn_kernel_lse_strides == NULL)) {
    ...
    condval_36 = ((int32_t)((int64_t*)flashattn_kernel_lse_strides)[0]);
  }
  if (condval_36 != (seq_q * 32)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"flashattn_kernel";
    ...
    if ((flashattn_kernel_lse_strides == NULL)) {
      ...
      condval_37 = ((int32_t)((int64_t*)flashattn_kernel_lse_strides)[0]);
    }
  ...
  result_66.v_int64 = 0;
  if (TVMFFIFunctionCall(__tvm_set_device_packed, (TVMFFIAny*) stack_ffi_any, 2, &result_66) != 0) {
    return -1;
  }
  if (K == NULL) {
  ...
  (((TVMFFIAny*)stack_ffi_any)[4].v_ptr) = lse;
  (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 1;
  (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = ((int64_t)seq_kv);
  (((TVMFFIAny*)stack_ffi_any)[6].type_index) = 1;
  (((TVMFFIAny*)stack_ffi_any)[6].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[6].v_int64) = ((int64_t)seq_q);
  (((TVMFFIAny*)stack_ffi_any)[7].type_index) = 1;
  (((TVMFFIAny*)stack_ffi_any)[7].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[7].v_int64) = ((int64_t)((seq_q + 127) >> 7));
  ...
  (((TVMFFIAny*)stack_ffi_any)[13].v_int64) = ((int64_t)65536);
  ...
  if (flashattn_kernel_kernel_packed == NULL) {
    if (TVMBackendGetFuncFromEnv(__tvm_ffi__library_ctx, "flashattn_kernel_kernel", &flashattn_kernel_kernel_packed) != 0) {
      return -1;
    }
  }
  TVMFFIAny result_67;
  ...
  result_67.v_int64 = 0;
  if (TVMFFIFunctionCall(flashattn_kernel_kernel_packed, (TVMFFIAny*) stack_ffi_any, 14, &result_67) != 0) {
    return -1;
  }
  return 0;
}
...
int32_t __tvm_ffi_main(void* self, void* args,int num_args, void* result) {
  return flashattn_kernel(self, args, num_args, result);
}

...
extern "C"
#endif
int32_t kernel(void* self_handle, void* args, int32_t num_args, void* result);
#ifdef __cplusplus
extern "C"
#endif
int32_t kernel(void* self_handle, void* args, int32_t num_args, void* result) {
  ...
  if (!((num_args == 2))) {
    ...
    snprintf(__tvm_assert_msg_buf, 512, "%s; expected: %lld, got: %lld", "kernel: num_args should be 2", (long long)(num_args), (long long)(2));
  ...
  int32_t block_mask_handle_type_index = (((TVMFFIAny*)args)[0].type_index);
  if (!(((((block_mask_handle_type_index == 0) || (block_mask_handle_type_index == 4)) || (block_mask_handle_type_index == 7)) || (64 <= block_mask_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel kernel input block_mask expected pointer or tensor handle");
    return -1;
  }
  int32_t idx_map_handle_type_index = (((TVMFFIAny*)args)[1].type_index);
  if (!(((((idx_map_handle_type_index == 0) || (idx_map_handle_type_index == 4)) || (idx_map_handle_type_index == 7)) || (64 <= idx_map_handle_type_index)))) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel kernel input idx_map expected pointer or tensor handle");
    return -1;
  }
  void* block_mask_handle = ((block_mask_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[0].v_ptr) + 24)) : (((TVMFFIAny*)args)[0].v_ptr));
  void* idx_map_handle = ((idx_map_handle_type_index == 70) ? ((void*)((char*)(((TVMFFIAny*)args)[1].v_ptr) + 24)) : (((TVMFFIAny*)args)[1].v_ptr));
  bool kernel_block_mask_is_null = (block_mask_handle == NULL);
  if (!(!kernel_block_mask_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel.block_mask is expected to have non-NULL pointer");
    return -1;
  }
  bool kernel_idx_map_is_null = (idx_map_handle == NULL);
  if (!(!kernel_idx_map_is_null)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "kernel.idx_map is expected to have non-NULL pointer");
    return -1;
  }
  void* kernel_block_mask_shape = (((DLTensor*)block_mask_handle)[0].shape);
  void* kernel_idx_map_shape = (((DLTensor*)idx_map_handle)[0].shape);
  if ((((DLTensor*)block_mask_handle)[0].ndim) != 3) {
    ...
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"kernel";
  ...
  if (!((bool)1)) {
    TVMFFIErrorSetRaisedFromCStr("RuntimeError", "Symbolic shape variable blocks_per_head requires at least one non-null buffer among: kernel.block_mask, kernel.idx_map");
    return -1;
  }
  int32_t blocks_per_head = ((int32_t)((int64_t*)kernel_block_mask_shape)[2]);
  void* kernel_block_mask_strides = (((DLTensor*)block_mask_handle)[0].strides);
  int32_t dev_id = (((DLTensor*)block_mask_handle)[0].device.device_id);
  ...
  void* kernel_idx_map_strides = (((DLTensor*)idx_map_handle)[0].strides);
  ...
  if (((int32_t)((int64_t*)kernel_block_mask_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)kernel_block_mask_shape)[0]));
  ...
  if (((int32_t)((int64_t*)kernel_block_mask_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)kernel_block_mask_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval;
  if ((kernel_block_mask_strides == NULL)) {
    condval = 1;
  } else {
    condval = ((int32_t)((int64_t*)kernel_block_mask_strides)[2]);
  }
  if (condval != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((kernel_block_mask_strides == NULL)) {
      ...
      condval_1 = ((int32_t)((int64_t*)kernel_block_mask_strides)[2]);
    }
  ...
  if ((kernel_block_mask_strides == NULL)) {
    ...
    condval_2 = ((int32_t)((int64_t*)kernel_block_mask_strides)[1]);
  }
  if (condval_2 != ((int32_t)((int64_t*)kernel_block_mask_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)((int32_t)((int64_t*)kernel_block_mask_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    int32_t condval_3;
    if ((kernel_block_mask_strides == NULL)) {
      ...
      condval_3 = ((int32_t)((int64_t*)kernel_block_mask_strides)[1]);
    }
  ...
  if ((kernel_block_mask_strides == NULL)) {
    ...
    condval_4 = ((int32_t)((int64_t*)kernel_block_mask_strides)[0]);
  }
  if (condval_4 != (blocks_per_head * 8)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"kernel";
    ...
    if ((kernel_block_mask_strides == NULL)) {
      ...
      condval_5 = ((int32_t)((int64_t*)kernel_block_mask_strides)[0]);
    }
  ...
  if (((int32_t)((int64_t*)kernel_idx_map_shape)[0]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)kernel_idx_map_shape)[0]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)kernel_idx_map_shape)[1]) != 8) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)kernel_idx_map_shape)[1]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  if (((int32_t)((int64_t*)kernel_block_mask_shape)[2]) != ((int32_t)((int64_t*)kernel_idx_map_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)((int32_t)((int64_t*)kernel_idx_map_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[4].v_int64) = ((int64_t)((int32_t)((int64_t*)kernel_block_mask_shape)[2]));
    (((TVMFFIAny*)stack_ffi_any)[5].type_index) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[5].v_int64) = (int64_t)0;
    if (__tvm_error_expect_eq_packed == NULL) {
  ...
  int32_t condval_6;
  if ((kernel_idx_map_strides == NULL)) {
    condval_6 = 1;
  } else {
    condval_6 = ((int32_t)((int64_t*)kernel_idx_map_strides)[2]);
  }
  if (condval_6 != 1) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    ...
    if ((kernel_idx_map_strides == NULL)) {
      ...
      condval_7 = ((int32_t)((int64_t*)kernel_idx_map_strides)[2]);
    }
  ...
  if ((kernel_idx_map_strides == NULL)) {
    ...
    condval_8 = ((int32_t)((int64_t*)kernel_idx_map_strides)[1]);
  }
  if (condval_8 != ((int32_t)((int64_t*)kernel_block_mask_shape)[2])) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"kernel";
    ...
    if ((kernel_idx_map_strides == NULL)) {
      ...
      condval_9 = ((int32_t)((int64_t*)kernel_idx_map_strides)[1]);
    }
  ...
  if ((kernel_idx_map_strides == NULL)) {
    ...
    condval_10 = ((int32_t)((int64_t*)kernel_idx_map_strides)[0]);
  }
  if (condval_10 != (blocks_per_head * 8)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"kernel";
    ...
    if ((kernel_idx_map_strides == NULL)) {
      ...
      condval_11 = ((int32_t)((int64_t*)kernel_idx_map_strides)[0]);
    }
  ...
  if ((uint64_t)0 != (((DLTensor*)idx_map_handle)[0].byte_offset)) {
    ...
    result_19.v_int64 = 0;
    if (TVMFFIFunctionCall(__tvm_error_byte_offset_mismatch_packed, (TVMFFIAny*) stack_ffi_any, 4, &result_19) != 0) {
      return -1;
    }
  }
  if ((((DLTensor*)idx_map_handle)[0].device.device_id) != (((DLTensor*)block_mask_handle)[0].device.device_id)) {
    (((TVMFFIAny*)stack_ffi_any)[0].type_index) = 8;
    (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
    (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = (void*)"kernel";
    ...
    (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
    (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)(((DLTensor*)block_mask_handle)[0].device.device_id));
    (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
    (((TVMFFIAny*)stack_ffi_any)[4].zero_padding) = 0;
  ...
  result_23.v_int64 = 0;
  if (TVMFFIFunctionCall(__tvm_set_device_packed, (TVMFFIAny*) stack_ffi_any, 2, &result_23) != 0) {
    return -1;
  }
  if (block_mask == NULL) {
  ...
  (((TVMFFIAny*)stack_ffi_any)[0].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[0].v_int64) = 0;
  (((TVMFFIAny*)stack_ffi_any)[0].v_ptr) = block_mask;
  if (idx_map == NULL) {
  ...
  (((TVMFFIAny*)stack_ffi_any)[1].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[1].v_int64) = 0;
  (((TVMFFIAny*)stack_ffi_any)[1].v_ptr) = idx_map;
  (((TVMFFIAny*)stack_ffi_any)[2].type_index) = 1;
  (((TVMFFIAny*)stack_ffi_any)[2].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[2].v_int64) = ((int64_t)blocks_per_head);
  (((TVMFFIAny*)stack_ffi_any)[3].type_index) = 1;
  (((TVMFFIAny*)stack_ffi_any)[3].zero_padding) = 0;
  (((TVMFFIAny*)stack_ffi_any)[3].v_int64) = ((int64_t)8);
  (((TVMFFIAny*)stack_ffi_any)[4].type_index) = 1;
  ...
  result_24.v_int64 = 0;
  if (TVMFFIFunctionCall(kernel_kernel_packed, (TVMFFIAny*) stack_ffi_any, 8, &result_24) != 0) {
    return -1;
  }
  return 0;
}
...
int32_t __tvm_ffi_main(void* self, void* args,int num_args, void* result) {
  return kernel(self, args, num_args, result);
}

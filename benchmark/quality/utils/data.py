...
def get_c4(n_train_samples, n_eval_samples, seqlen, tokenizer):
    ...
    train_dataset = TextDataset(raw_tra_data, tokenizer, col_key="text", cutoff=n_train_samples, seqlen=seqlen)
    val_dataset = TextDataset(
        raw_val_data, tokenizer, col_key="text", cutoff=n_eval_samples, seqlen=seqlen  # todo: change to 1100
    )

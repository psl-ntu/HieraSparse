...
BEST_CONFIGS = {
    "NVIDIA L40S": {
        # Tile-lang: 320.77 ms 219.37 TFlops
        # CUDNN: 426.42 ms 165.02 TFlops 1.33x
        # FLASH_ATTENTION: 432.78 ms 162.60 TFlops 1.35x
        (8, 32, 8, True): {"block_M": 128, "threads": 128, "use_movmatrix": True},
        # Tile-lang: 40.05 ms 219.61 TFlops
        # CUDNN: 50.90 ms 172.81 TFlops 1.27x
        # FLASH_ATTENTION: 51.25 ms 171.61 TFlops 1.28x
        (1, 32, 8, True): {"block_M": 128, "threads": 128, "use_movmatrix": True},
    },
...
def blockattn_sp_dk_mv(
    ...
    # Key
    k_shape = [batch, groups, dummy0, dim]
    ...
    def blockattn_sp_dk_mv_kernel(
        ...
        with T.Kernel(T.ceildiv(seq_q, block_M), heads, batch, threads=threads) as (bx, by, bz):
            ...
            for k in T.serial(loop_range):
                ...
                MMA0(Q_shared, K_shared, acc_s_T)
    ...
    return blockattn_sp_dk_mv_kernel
...
def main(
    ...
    from hierasparse.compress_method import torch_block_compress_value
    from hierasparse.prune_method import prune_block_value
    ...
    v_page_idx = v_page_idx.to(torch.int16)

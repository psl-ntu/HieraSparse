...
BEST_CONFIGS = {
    "NVIDIA L40S": {
        # Tile-lang: 259.48 ms 271.20 TFlops
        # CUDNN: 408.67 ms 172.19 TFlops 1.57x
        # FLASH_ATTENTION: 414.11 ms 169.93 TFlops 1.60x
        (8, 32, 8, True): {"block_M": 128, "threads": 128, "use_movmatrix": True},
        # Tile-lang: 34.20 ms 257.21 TFlops
        # CUDNN: 49.16 ms 178.94 TFlops 1.44x
        # FLASH_ATTENTION: 49.74 ms 176.84 TFlops 1.45x
